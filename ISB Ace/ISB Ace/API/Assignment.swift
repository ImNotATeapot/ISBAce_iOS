...
class Assignment: NSObject{
    ...
    private var _letterGrade = String?()
    private var _score = String?()
    private var _percent = String?()
    private var _pointsPossible = String?()
    ...
    ///The lettergrade that the student received
    var letterGrade: String?{
        return _letterGrade
    }
    var pointsPossible: String?{
    ...
    init(details: [String: [String: String]?]){
        ...
        if details["score"]! != nil {
            ...
            self._letterGrade = score["letterGrade"]
            self._pointsPossible = assignment["pointspossible"]
        }else{
            self._percent = nil
            self._score = nil
            self._letterGrade = nil
            self._pointsPossible = nil
        }
